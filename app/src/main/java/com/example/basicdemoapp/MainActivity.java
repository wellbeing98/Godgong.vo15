...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        findViewById(R.id.make_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startMeetingDialog();
            }
    ...
    private void createJoinMeetingDialog() {
        new AlertDialog.Builder(this)
                .setView(R.layout.dialog_logjoin)
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (numberInput != null && numberInput.getText() != null && passwordInput != null && passwordInput.getText() != null) {
                            ...
                            if (meetingNumber.trim().length() > 0 && password.trim().length() > 0) {
                                joinMeeting(MainActivity.this, Name, meetingNumber, password);
                            }
                        }
                        dialog.dismiss();
                    }
